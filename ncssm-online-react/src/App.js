...
import CapeFear from './components/public-page/CapeFear';
import ChowanRoanok from './components/public-page/ChowanRoanoke';
import EdistoSantee from './components/public-page/EdistoSantee';
import NeusePamlio from './components/public-page/NeusePamlio';
import PeeDee from './components/public-page/PeeDee';
    ...
    <Router>
      ...
      <div>
        <Routes>
          ...
          <Route path ="/CapeFear" element = {<CapeFear />}/>
          <Route path ="/Chowan" element = {<ChowanRoanok />}/>
          <Route path ="/Edisto" element = {<EdistoSantee />}/>
          <Route path ="/Neuse" element = {<NeusePamlio/>}/>
          <Route path ="/PeeDee" element = {<PeeDee/>}/>
